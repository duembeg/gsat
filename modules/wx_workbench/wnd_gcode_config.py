...
class gsatGcodeSettingsPanel(scrolled.ScrolledPanel):
    """
    Program settings
    ...
    def __init__(self, parent, config_data, key="code"):
        super(gsatGcodeSettingsPanel, self).__init__(parent, style=wx.TAB_TRAVERSAL | wx.NO_BORDER)
    ...
    def InitUI(self):
        ...
        if self.key == 'code':
            ...
            self.gCodeHighlight = csel.ColourSelect(
                self, -1, "", hex_to_rgb(self.configData.get(f"/{self.key}/GCodeHighlight")))
            ...
            self.gModeHighlight = csel.ColourSelect(
                self, -1, "", hex_to_rgb(self.configData.get(f"/{self.key}/MCodeHighlight")))
            ...
            self.axisHighlight = csel.ColourSelect(
                self, -1, "", hex_to_rgb(self.configData.get(f"/{self.key}/AxisHighlight")))
            ...
            self.parametersHighlight = csel.ColourSelect(
                self, -1, "", hex_to_rgb(self.configData.get(f"/{self.key}/ParametersHighlight")))
            ...
            self.parameters2Highlight = csel.ColourSelect(
                self, -1, "", hex_to_rgb(self.configData.get(f"/{self.key}/Parameters2Highlight")))
            ...
            self.commentsHighlight = csel.ColourSelect(
                self, -1, "", hex_to_rgb(self.configData.get(f"/{self.key}/CommentsHighlight")))
            ...
            self.gCodeLineNumberHighlight = csel.ColourSelect(
                self, -1, "", hex_to_rgb(self.configData.get(f"/{self.key}/GCodeLineNumberHighlight")))
