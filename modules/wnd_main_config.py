...
class gsatGeneralSettingsPanel(scrolled.ScrolledPanel):
    ...
    def InitUI(self):
        ...
        self.scFileHistory.SetValue(self.configData.get('/mainApp/FileHistory/FilesMaxHistory'))
    ...
    def UpdateConfigData(self):
        ...
        self.configData.set('/mainApp/FileHistory/FilesMaxHistory', self.scFileHistory.GetValue())
...
class gsatSettingsDialog(wx.Dialog):
    ...
    def __init__(
            self, parent, config_data, config_remote_data=None, id=wx.ID_ANY, title="Settings",
    ...
    def InitUI(self):
        ...
        self.noteBook = wx.Notebook(self, size=(1000, 600), style=wx.BK_DEFAULT)
        ...
        sizer.Add(line, 0, wx.GROW | wx.LEFT | wx.RIGHT | wx.TOP, border=5)
