...
"""----------------------------------------------------------------------------
    ...
    Legacy wxPython desktop UI (maintenance only). Day-to-day UI is
    gsat-pyside.py. This entry may be removed in a future major.
...
import modules.wx_workbench.wnd_main as mw
